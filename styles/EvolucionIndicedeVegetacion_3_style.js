...
var style_EvolucionIndicedeVegetacion_3 = function(feature, resolution){
    ...
    if (value >= -0.578045 && value <= -0.447462) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.447462 && value <= -0.316880) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.316880 && value <= -0.186297) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.186297 && value <= -0.055714) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.055714 && value <= 0.074869) {
            style = [ new ol.style.Style({
