...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.145999 && value <= -0.060687) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.060687 && value <= 0.024626) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.024626 && value <= 0.109939) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.109939 && value <= 0.195251) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.195251 && value <= 0.280564) {
            style = [ new ol.style.Style({
