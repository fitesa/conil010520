...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.241057 && value <= 0.325554) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.325554 && value <= 0.410051) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.410051 && value <= 0.494548) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.494548 && value <= 0.579045) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.579045 && value <= 0.663542) {
            style = [ new ol.style.Style({
