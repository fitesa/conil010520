...
var style_EvolucionIndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.448830 && value <= -0.353279) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.353279 && value <= -0.257728) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.257728 && value <= -0.162178) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.162178 && value <= -0.066627) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.066627 && value <= 0.028924) {
            style = [ new ol.style.Style({
